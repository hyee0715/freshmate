...
.Request Fields
include::{snippets}/recipe/recipe-create/request-fields.adoc[]
.Request Body
include::{snippets}/recipe/recipe-create/request-body.adoc[]
...
.Request Body
include::{snippets}/recipe/recipe-scrap/request-body.adoc[]
...
---
== GET: 사용자가 작성하고 스크랩한(소유한) 모든 레시피 조회
=== 성공
...
include::{snippets}/recipe/recipe-find-all-by-owner-id/request-body.adoc[]
.Request Body
